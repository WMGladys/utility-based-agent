class environment(object):
    ...
    goal = "9" #End point
    #keys in string should be unique
    #cost is not unique hence becomes the value
cost = {str(["1","2"]): "3", str(["1","4"]): "5",
        str(["2","1"]):"3", str(["2","3"]):"5",
        str(["2","5"]):"7", str(["3","2"]):"5",
        str(["3","6"]):"9", str(["4","1"]):"5",
        str(["4","5"]):"9", str(["4","7"]):"11",
        str(["5","2"]):"7", str(["5","4"]):"9",
        str(["5","8"]):"13", str(["5","6"]):"11",
        str(["6","3"]):"9", str(["6","5"]):"11",
        str(["6","9"]):"15", str(["7","4"]):"11",
        str(["7","8"]):"15", str(["8","5"]):"13",
        str(["8","7"]):"15", str(["8","9"]):"17",
...
class agent(environment):
        ...
        while stack:
            ...
            for next in graph[vertex]-set(path):
                ...
                # paths identified by dfs techniques: path + [next]
                    ...
                    # update least cost and least cost path
    ...
    def __init__(self, environment):
        print("ucs cheapest path", agent.ucs(environment.my_graph,
